...
<?php
	  ...
	  <div class="header_top">
			<div class="logo">
			  ...
			  <div class="header_top_right">
			    <div class="search_box">
				    <form>
				    	<input type="text" value="Search for Products" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Nhập tên sản phẩm';}"><input type="submit" value="Tìm kiếm">
				    </form>
			    </div>
			...
			?>
		   <div class="login" style="background:  #3e3d42">
				<?php
				 $login_check =  Session::get('customer_login');
				if($login_check == 	false){
